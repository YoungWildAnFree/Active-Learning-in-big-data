...
if __name__=="__main__":
    conf = SparkConf().setMaster("spark://master:7077").setAppName("ActiveLearn")
    ...
    select_num = 500  #选择最小样例个数
    feature_num =10  #数据集中属性个数 从0列到
    class_index = 11-1 #类标属性在第几列

    frist_filter =0.5  # 初步过滤的概率值 小frist_filter值得将被选出
    #读入整个数据
    ...
    test_data = split_data.sample(False, 0.01, 87)
